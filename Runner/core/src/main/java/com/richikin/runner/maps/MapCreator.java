...
//        parseObjectTiles();
    ...
    private ObjectTileProperties setObjectTileProperties(SpriteDescriptor descriptor)
    {
        ...
        switch (descriptor._TILE)
        {
            ...
            case _LOOP_BLOCK_HORIZONTAL_TILE:
            case _LOOP_BLOCK_VERTICAL_TILE:
            case _SPIKE_BALL_TILE:
            case _SPIKE_BLOCK_DOWN_TILE:
            case _SPIKE_BLOCK_UP_TILE:
            case _SPIKE_BLOCK_LEFT_TILE:
            case _SPIKE_BLOCK_RIGHT_TILE:
            {
